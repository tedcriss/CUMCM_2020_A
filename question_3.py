...
if __name__ == '__main__':
    ...
    plt.text(tNp[numpy.where(TtNp == TtNp.max())[0][0]], TtNp.max(), "maximum=" + str(round(TtNp.max(), 2))+\
             "\ntime="+str(round(tNp[numpy.where(TtNp == TtNp.max())[0][0]],2)))
    plt.scatter(tNp[numpy.where(TtNp == TtNp.max())[0][0]], TtNp.max())
